            ...
            <div className="CarSection">
                ...
                <div className="carOutlookTapCont">
                    ...
                    {btnName.map(itemName => {
                        return <BtnSection role="button" className={btnClicked} onClick={this.btnTabcolorChange} id={itemName} isClickedName={this.state.isClickedName} />
                    })}
                    </ul>
                </div>
...
class BtnSection extends Component {
    ...
    render() {
        return(
            <li role="button" className={this.props.isClickedName === this.props.id ? this.props.className : ""} id={this.props.id} onClick={this.props.onClick}>{this.props.id}</li>
        );
    }
}
