        ...
        return (
            <div className="Footer">
                <div className="FooterWrapper">
                    ...
                    <div className="FooterBar">
                        <ul className="FooterBarList">
                            <li className="heading"><a href="#">서비스</a></li>
                            <li className="bold"><a href="#">딜러찾기</a></li>
                            <li className="bold"><a href="#">내차량만들기</a></li>
                        </ul>
                    </div>
                    <div className="FooterBar">
                        <ul className="FooterBarList">
                            <li className="heading"><a href="#">뉴스</a></li>
                            <li><a href="#">문의하기</a></li>
                        ...
                        <ul className="FooterBarList">
                            <li>
                                <div className="locator">
                                    <span><img src={require("../../images/footerImg.PNG")} alt="korea" /></span>
                ...
                <div className="FooterUnderCont">
                    ...
                    <div className="credits">
                        ...
                        <span><a href="#">Legal Notes</a></span>
                        <br></br>
                        <span><a href="#">개인정보 취급방침</a></span>
                        <span><a href="#">영상정보처리기기 운영 관리 방침</a></span>
                    </div>
                </div>
            </div>
        )
